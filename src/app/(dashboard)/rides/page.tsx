...
const SAMPLE_RIDES: Ride[] = [
    {
        ...
        type: "OFFER",
        origin: "IIT Goa Campus",
        destination: "Panjim Bus Stand",
    ...
    },
    {
        ...
        type: "REQUEST",
        origin: "Margao Railway Station",
        destination: "IIT Goa Campus",
    ...
    },
    {
        ...
        type: "OFFER",
        origin: "IIT Goa Campus",
        destination: "Goa Airport (Dabolim)",
